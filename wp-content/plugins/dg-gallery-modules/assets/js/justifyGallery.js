(function(){  
    if (jQuery().justifiedGallery) {
        jQuery('.dg_jsg_container').each(function(index, element) {
    ...
    jQuery(document.body).on('click','.dg_jsg_image', function(event) {
...
function dg_init_jsgallery(selector, settings) {
...
function dg_jsg_use_lightbox(selector, options) {
    if (options.use_lightbox === 'on') {
        var settings = {
            subHtmlSelectorRelative: true,
            addClass: 'dg_jsg_lightbox', 
            counter: false,
