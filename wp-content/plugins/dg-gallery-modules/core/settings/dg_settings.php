    ...
    class DG_Settings {
        ...
        public function load_admin_scripts(){
            ...
            if (isset($screen->base) && $screen->base === 'toplevel_page_divigear_options') {
                ...
                wp_localize_script( 'dg_admin_scripts', 'dggm_admin', [
                        'nonce' => wp_create_nonce('dggm_nonce')
                ]);
            }  
        }
        ...
        private function dg_settings_sections( $page ) {
            ...
            foreach ( (array) $wp_settings_sections[$page] as $section ) {
                ...
                echo '<div class="section-wrapper" data-navid="'.esc_attr( $section['id'] ).'" >';
                if ( $section['title'] )
        ...
        private function dg_settings_fields($page, $section) {
            ...
            foreach ( (array) $wp_settings_fields[$page][$section] as $field ) {
                ...
                self::template($template_url, $args);
            }
        }
