...
function dggm_plugin_update($checked_data) {
    global $wp_version;
    ...
    $api_key = isset($option['dggm_license_key_setting']) ? $option['dggm_license_key_setting'] : '';
    $status = isset($option['dggm_license_key_status']) ? $option['dggm_license_key_status'] : '';
