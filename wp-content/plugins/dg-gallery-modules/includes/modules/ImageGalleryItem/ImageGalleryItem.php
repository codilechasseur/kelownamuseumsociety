...
class DGGM_ImageGalleryItem extends ET_Builder_Module {
    public $slug       = 'dggm_imagegalleryitem';
    ...
    public function init() {
        // $this->no_render = true;
        $this->name = esc_html__( 'Advanced Gallery Item', 'dggm-gallery-modules' );
    ...
    public function get_fields() {
        $general = array (
            ...
            'admin_label' => array (
                'label'           => esc_html__( 'Admin Label', 'dggm-gallery-modules' ),
                'type'            => 'text',
