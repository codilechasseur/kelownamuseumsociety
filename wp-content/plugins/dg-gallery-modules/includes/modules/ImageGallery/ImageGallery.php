...
class DGGM_ImageGallery extends ET_Builder_Module {
    public $slug       = 'dggm_imagegallery';
    public $vb_support = 'on';
    public $child_slug = 'dggm_imagegalleryitem';
    use DGGM_UTLS;
    ...
    public function init() {
        $this->name = esc_html__( 'Advanced Gallery', 'dggm-gallery-modules' );
        $this->main_css_element = "%%order_class%%";
        $this->icon_path        =  DGGM_ASSETS_DIR_PATH . 'img/module-icons/image-gallery.svg';
    }
        ...
        return array(
            ...
            'advanced'   => array(
                'toggles'   => array(
                    ...
                    'image'                 => esc_html__('Image', 'dggm-gallery-modules'),
                    'filter_btn'            => esc_html__('Filter Buttons', 'dggm-gallery-modules'),
                    'filter_btn_active'     => esc_html__('Active Filter Button', 'dggm-gallery-modules'),
                    'more_btn'              => esc_html__('Load More Button', 'dggm-gallery-modules'),
                    'dg_borders'            => esc_html__('Borders', 'dggm-gallery-modules'),
                    'pagination'            => esc_html__( 'Pagination Button Styles', 'dggm-gallery-modules' ),
                    'active_pagination'     => esc_html__( 'Active Pagination Number', 'dggm-gallery-modules' ),
                )
            )
        );
    }
    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields['fonts'] = array(
            'caption'     => array(
                ...
                'css'      => array(
                    'main' => "%%order_class%% .dg_ig_caption",
                    'hover' => "%%order_class%% .dg_ig_image:hover .dg_ig_caption",
                    'important'	=> 'all'
                ),
            ),
            'description'     => array(
                ...
                'css'      => array(
                    'main' => "%%order_class%% .dg_ig_description",
                    'hover' => "%%order_class%% .dg_ig_image:hover .dg_ig_description",
                    'important'	=> 'all'
                ),
            ),
            'filter_btns'     => array(
                'label'         => esc_html__( 'Filter Buttons', 'dggm-gallery-modules' ),
                ...
                'css'      => array(
                    'main' => "%%order_class%% .dg_filter_buttons button",
                    'hover' => "%%order_class%% .dg_filter_buttons button:hover",
                    'important'	=> 'all'
                ),
            ),
            'active_filter_btn'     => array(
                'label'         => esc_html__( 'Active Button', 'dggm-gallery-modules' ),
                ...
                'css'      => array(
                    'main' => "%%order_class%% .dg_filter_buttons button.is-checked",
                    'hover' => "%%order_class%% .dg_filter_buttons button.is-checked:hover",
                    'important'	=> 'all'
                ),
            ),
            'more_btn'     => array(
        ...
        $advanced_fields['borders'] = array(
            ...
            'filter_container'      => array (
                'css'               => array(
                    'main' => array(
                        'border_radii' => '%%order_class%% .dg_filter_buttons',
                        'border_styles' => '%%order_class%% .dg_filter_buttons',
                        'border_styles_hover' => '%%order_class%% .dg_filter_buttons:hover',
                    )
                ),
                'tab_slug'          => 'advanced',
            ...
            'image'                 => array (
                'css'               => array(
                    'main' => array(
                        'border_radii' => '%%order_class%% .dg_ig_image .item-content',
                        'border_styles' => '%%order_class%% .dg_ig_image .item-content',
                        'border_styles_hover' => '%%order_class%% .dg_ig_image:hover .item-content',
                    )
                ),
                'tab_slug'          => 'advanced',
                'toggle_slug'       => 'dg_borders',
            ...
            'filter_btn'            => array (
                'css'               => array(
                    'main' => array(
                        'border_radii' => '%%order_class%% .dg_filter_buttons button',
                        'border_styles' => '%%order_class%% .dg_filter_buttons button',
                        'border_styles_hover' => '%%order_class%% .dg_filter_buttons button:hover',
                    )
                ),
                'tab_slug'          => 'advanced',
                'toggle_slug'       => 'filter_btn',
            ...
            'active_filter_btn'            => array (
                'css'               => array(
                    'main' => array(
                        'border_radii' => '%%order_class%% .dg_filter_buttons button.is-checked',
                        'border_styles' => '%%order_class%% .dg_filter_buttons button.is-checked',
                        'border_styles_hover' => '%%order_class%% .dg_filter_buttons button.is-checked:hover',
                    )
                ),
                'tab_slug'          => 'advanced',
                'toggle_slug'       => 'filter_btn_active',
    ...
    public function get_fields() {
        ...
        $general = array (
	        'dg_gallery_enable_category' => array(
		        'label'       => esc_html__( 'Use Category', 'dggm-gallery-modules' ),
		        'type'        => 'yes_no_button',
		        'options'     => array(
	        ...
	        'category_ids' => array(
		        'label'            => esc_html__( 'Category', 'dggm-gallery-modules' ),
		        'type'             => 'dggm_multi_select',
		        'default'          => '[]',
		        'default_in_front' => '[]',
		        'tab_slug'         => 'general',
		        'toggle_slug'      => 'settings',
		        'show_if'          => array(
			        'dg_gallery_enable_category' => 'on',
		        ),
	        ),
            'image_size'    => array(
                ...
                'type'          => 'select',
                'options'       => array (
                    'thumbnail' => esc_html__('Thumbnail', 'dggm-gallery-modules'),
            ...
            'image_to_display'    => array(
                'label'    => esc_html__('Image in row', 'dggm-gallery-modules'),
                'type'          => 'select',
                'options'       => array (
                    '1'     => esc_html__('1 Item', 'dggm-gallery-modules'),
                    '2'     => esc_html__('2 Items', 'dggm-gallery-modules'),
                    '3'     => esc_html__('3 Items', 'dggm-gallery-modules'),
                    '4'     => esc_html__('4 Items', 'dggm-gallery-modules'),
                    '5'     => esc_html__('5 Items', 'dggm-gallery-modules'),
                    '6'     => esc_html__('6 Items', 'dggm-gallery-modules'),
                    '7'     => esc_html__('7 Items', 'dggm-gallery-modules'),
                    '8'     => esc_html__('8 Items', 'dggm-gallery-modules')
                ),
                'default'       => '4',
                'toggle_slug'   => 'settings',
                'mobile_options'=> true
            ...
            'layout_mode'    => array(
                'label'    => esc_html__('Layout Mode', 'dggm-gallery-modules'),
                'type'          => 'select',
                'options'       => array (
                    'masonry'     => esc_html__('Masonry', 'dggm-gallery-modules'),
                    'fitRows'     => esc_html__('Grid', 'dggm-gallery-modules')
                ),
                'default'       => 'masonry',
                'toggle_slug'   => 'settings'
            ),
	        'use_orientation'    => array(
		        'label'         => esc_html__('Use Image Orientation', 'dggm-gallery-modules'),
		        'type'          => 'yes_no_button',
		        'options'       => array (
			        'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
			        'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
	        ...
	        'image_orientation'                    => array(
		        'label'            => esc_html__( 'Image Orientation', 'dggm-gallery-modules' ),
		        'type'             => 'select',
		        'options_category' => 'configuration',
		        'options'          => array(
			        'landscape' => esc_html__( 'Landscape', 'dggm-gallery-modules' ),
			        'portrait'  => esc_html__( 'Portrait', 'dggm-gallery-modules' ),
		        ),
            ...
            'use_image_order'    => array(
                'label'         => esc_html__('Use Image Order', 'dggm-gallery-modules'),
                'type'          => 'yes_no_button',
                'options'       => array (
                    'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
                    'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
            ...
            'image_order'    => array(
                'label'    => esc_html__('Image Order', 'dggm-gallery-modules'),
                'type'          => 'select',
                'options'       => array (
                    'random'        => esc_html__('Random', 'dggm-gallery-modules'),
                    'asc'           => esc_html__('ASC', 'dggm-gallery-modules'),
                    'desc'          => esc_html__('DESC', 'dggm-gallery-modules')
                ),
                'default'       => 'random',
                'toggle_slug'   => 'settings',
                'show_if'       => array(
            ...
            'filter_nav'    => array(
                'label'         => esc_html__('Filter Nav', 'dggm-gallery-modules'),
                'type'          => 'yes_no_button',
                'options'       => array (
                    'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
                    'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
	        ...
	        'disable_filter_nav_all_button'    => array(
		        'label'         => esc_html__('Disable First Nav', 'dggm-gallery-modules'),
		        'type'          => 'yes_no_button',
		        'options'       => array (
			        'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
			        'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
            ...
            'filter_nav_all_button'    => array(
                'label'         => esc_html__('First Nav Text', 'dggm-gallery-modules'),
                'type'          => 'text',
                'default'       => 'All',
                'toggle_slug'   => 'settings',
                'show_if'       => array(
	        ...
	        'show_pagination'                      => array(
		        'label'       => esc_html__( 'Show Pagination', 'dggm-gallery-modules' ),
		        'type'        => 'yes_no_button',
		        'options'     => array(
			        'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
			        'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
	        ...
	        'pagination_img_count' => array(
		        'label'       => esc_html__( 'Pagination Image Count', 'dggm-gallery-modules' ),
		        'type'        => 'text',
		        'default'     => '6',
		        'toggle_slug' => 'settings',
		        'show_if'     => array(
	        ...
	        'use_number_pagination'                => array(
		        'label'       => esc_html__( 'Use Number Pagination', 'dggm-gallery-modules' ),
		        'type'        => 'yes_no_button',
		        'options'     => array(
			        'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
			        'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
	        ...
	        'use_icon_only_at_pagination'          => array(
		        'label'       => esc_html__( 'Use Icon Only in Next and Previous Button', 'dggm-gallery-modules' ),
		        'type'        => 'yes_no_button',
		        'options'     => array(
			        'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
			        'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
	        ...
	        'older_text'                           => array(
		        'label'       => esc_html__( 'Older Entries Button Text', 'dggm-gallery-modules' ),
		        'type'        => 'text',
		        'toggle_slug' => 'settings',
	        ...
	        'newer_text'                           => array(
		        'label'       => esc_html__( 'Next Entries Button Text', 'dggm-gallery-modules' ),
		        'type'        => 'text',
		        'toggle_slug' => 'settings',
        ...
        $hover = array(
            ...
            'field_icon_color'      => array(
	            'label'           => esc_html__( 'Icon Color', 'dggm-gallery-modules' ),
	            'type'            => 'color-alpha',
	            'description'     => esc_html__( 'Here you can define a custom color for your icon.', 'dggm-gallery-modules' ),
	            'depends_show_if' => 'on',
	            'toggle_slug'     => 'hover',
	            'hover'           => 'tabs',
	            'show_if'         => array(
            ...
            'field_icon_placement' => array(
	            'label'       => esc_html__( 'Icon Placement', 'dggm-gallery-modules' ),
	            'type'        => 'select',
	            'options'     => array(
		            'start'  => esc_html__( 'Top', 'dggm-gallery-modules' ),
		            'center' => esc_html__( 'Center', 'dggm-gallery-modules' ),
		            'end'    => esc_html__( 'Bottom', 'dggm-gallery-modules' ),
	            ),
	            'default'     => 'center',
	            'tab_slug'    => 'general',
	            'toggle_slug' => 'hover',
	            'description' => esc_html__( 'You can control the placement of the hover overlay icon', 'dggm-gallery-modules' ),
	            'show_if'     => array(
		            'overlay'  => 'on',
		            'field_use_icon' => 'on'
	            ),
            ...
            'field_icon_alignment' => array(
	            'label'           => esc_html__( 'Icon Alignment', 'dggm-gallery-modules' ),
	            'type'            => 'multiple_buttons',
	            'options'         => array(
		            'start'  => array(
			            'title' => esc_html__( 'Left', 'dggm-gallery-modules' ),
			            'icon'  => 'align-left', // Any svg icon that is defined on ETBuilderIcon component
		            ),
		            'center' => array(
			            'title' => esc_html__( 'Center', 'dggm-gallery-modules' ),
			            'icon'  => 'align-center', // Any svg icon that is defined on ETBuilderIcon component
		            ),
		            'end'    => array(
			            'title' => esc_html__( 'Right', 'dggm-gallery-modules' ),
	            ...
	            'tab_slug'        => 'general',
	            'toggle_slug'     => 'hover',
	            'description'     => esc_html__( 'You can control the hover overlay icon alignment', 'dggm-gallery-modules' ),
	            'show_if'         => array(
		            'overlay'  => 'on',
		            'field_use_icon' => 'on'
	            ),
            ...
            'content_reveal_icon'    => array(
	            'label'    => esc_html__('Icon Reveal', 'dggm-gallery-modules'),
	            'type'          => 'select',
	            'options'       => array (
            ...
            'enable_content_position'    => array(
	            'label'         => esc_html__('Content Outside', 'dggm-gallery-modules'),
	            'type'          => 'yes_no_button',
	            'options'       => array (
		            'off' => esc_html__( 'Off', 'dggm-gallery-modules' ),
		            'on'  => esc_html__( 'On', 'dggm-gallery-modules' ),
        ...
        $filter_nav_bg = $this->dg_add_bg_field(array(
            'label'				=> 'Background',
            'key'               => 'filter_nav_bg',
            'toggle_slug'       => 'filter_btn',
            'tab_slug'			=> 'advanced',
        ...
        $active_filter_bg = $this->dg_add_bg_field(array(
            'label'				=> 'Background',
	    ...
	    $pagination = array(
		    'pagination_align'   => array(
			    'label'             => esc_html__('Pagination Alignment', 'dggm-gallery-modules'),
			    'type'              => 'select',
			    'options'           => array(
				    'center'          => esc_html__('Center', 'dggm-gallery-modules'),
				    'flex-start'      => esc_html__('Left', 'dggm-gallery-modules'),
				    'flex-end'        => esc_html__('Right', 'dggm-gallery-modules'),
				    'space-between'   => esc_html__('Justified', 'dggm-gallery-modules')
			    ),
			    'default'           => 'center',
			    'toggle_slug'       => 'pagination',
			    'tab_slug'          => 'advanced',
		    ...
		    'next_prev_icon'   => array(
			    'label'             => esc_html__('Next & Prev Icon', 'dggm-gallery-modules'),
			    'type'              => 'select',
			    'options'           => array(
				    'set_1'          => esc_html__('Set 1', 'dggm-gallery-modules'),
				    'set_2'          => esc_html__('Set 2', 'dggm-gallery-modules'),
				    'set_3'          => esc_html__('Set 3', 'dggm-gallery-modules'),
				    'set_4'          => esc_html__('Set 4', 'dggm-gallery-modules')
			    ),
			    'default'           => 'set_1',
			    'toggle_slug'       => 'pagination',
			    'tab_slug'          => 'advanced',
	    ...
	    $pagination_background = $this->dg_add_bg_field(array (
		    'label'				    => 'Background',
		    'key'                   => 'pagination_background',
		    'toggle_slug'           => 'pagination',
		    'tab_slug'              => 'advanced'
	    ));
	    $active_pagination_background = $this->dg_add_bg_field(array (
		    'label'				    => 'Background',
    ...
    public function get_transition_fields_css_props() {
        ...
        $fields = $this->dg_background_transition(array (
            'fields'        => $fields,
            'key'           => 'filter_nav_bg',
            'selector'      => '%%order_class%% .dg_filter_buttons button'
        ));
        $fields = $this->dg_background_transition(array (
            'fields'        => $fields,
            'key'           => 'more_btn_bg',
        ...
        $fields = $this->dg_background_transition(array (
            'fields'        => $fields,
            'key'           => 'active_filter_bg',
            'selector'      => '%%order_class%% .dg_filter_buttons button.is-checked'
        ));

        $fields['title_padding'] = array ('padding' => '%%order_class%% .dg_ig_caption');
        $fields['description_padding'] = array ('padding' => '%%order_class%% .dg_ig_description');
        $fields['filter_button_container_margin'] = array ('margin' => '%%order_class%% .dg_filter_buttons');
        $fields['filter_button_container_padding'] = array ('padding' => '%%order_class%% .dg_filter_buttons');
        $fields['filter_button_margin'] = array ('margin' => '%%order_class%% .dg_filter_buttons button');
        $fields['filter_button_padding'] = array ('padding' => '%%order_class%% .dg_filter_buttons button');
        ...
        $fields = $this->dg_fix_border_transition(
            $fields,
            'filter_container',
            '%%order_class%% .dg_filter_buttons'
        );
        $fields = $this->dg_fix_border_transition(
            $fields,
            'image',
            '%%order_class%% .dg_ig_image .item-content'
        );
        $fields = $this->dg_fix_border_transition(
            $fields,
            'filter_btn',
            '%%order_class%% .dg_filter_buttons button'
        );
        $fields = $this->dg_fix_border_transition(
            $fields,
            'active_filter_btn',
            '%%order_class%% .dg_filter_buttons button.is-checked'
        );
        $fields = $this->dg_fix_border_transition(
            $fields,
            'morebtn_border',
	    ...
	    /** --Overlay Icon-- **/
	    $fields['field_icon_color'] = array('color' => '%%order_class%% .dg-overlay .et-pb-icon');
	    /** --Overlay Icon-- **/
	    ...
	    $fields = $this->dg_fix_box_shadow_transition(
		    $fields,
		    'pagination',
		    $pagination
	    );
    ...
    public function additional_css_styles($render_slug) {
        ...
        $this->dg_process_range( array(
            ...
            'type'              => 'font-size',
            'selector'          => '%%order_class%% .dg-ig-load-more-icon'
        ) );
        ...
        $this->set_margin_padding_styles(array(
            ...
            'slug'              => 'title_padding',
            'type'              => 'padding',
            'selector'          => '%%order_class%% .dg_ig_caption',
            'hover'             => '%%order_class%% .item-content:hover .dg_ig_caption',
        ));
        // spacing: description
        $this->set_margin_padding_styles(array(
            'render_slug'       => $render_slug,
            ...
            'type'              => 'padding',
            'selector'          => '%%order_class%% .dg_ig_description',
            'hover'             => '%%order_class%% .item-content:hover .dg_ig_description',
        ));
        ...
        $this->set_margin_padding_styles(array(
            ...
            'type'              => 'margin',
            'selector'          => '%%order_class%% .dg_filter_buttons',
            'hover'             => '%%order_class%% .dg_filter_buttons:hover',
        ));
        $this->set_margin_padding_styles(array(
            'render_slug'       => $render_slug,
        ...
        if(method_exists('ET_Builder_Module_Helper_Style_Processor', 'process_extended_icon')) {
	        ...
	        $this->generate_styles(
		        array(
			        ...
			        'important'      => true,
			        'selector'       => '%%order_class%% .dg-overlay .et-pb-icon',
			        'processor'      => array(
				        'ET_Builder_Module_Helper_Style_Processor',
				        'process_extended_icon',
			        ),
	    ...
	    if('on' === $this->props['field_use_icon']){
		    ...
		    ET_Builder_Element::set_style($render_slug, array(
			    'selector' => '%%order_class%% .dg-overlay',
	    ...
	    $this->dg_process_string_attr(array(
		    'render_slug'       => $render_slug,
    ...
    public function render( $attrs, $content, $render_slug ) {
        ...
        wp_enqueue_script('dggm-gallery-lib');
        wp_enqueue_script('dggm-image-gallery');
        ...
        $image_ids = '';
        $images_array = [];
	    if('on' === $this->props['dg_gallery_enable_category']){
		    ...
		    foreach ($tex_ids as $index => $value){
			    ...
			    $term_name = get_term_by('id', $term_id, DiviGear_Media_Category::TAXONOMY);
			    ...
			    $args = [
				    ...
				    'tax_query' => [
					    [
						    'taxonomy' => DiviGear_Media_Category::TAXONOMY,
						    'field'    => 'term_id',
						    'terms'    => $term_id,
					    ],
				    ],
        ...
        if( 'on' === $this->props['use_image_order'] ) {
            if( '' === $this->props['image_order'] || 'random' === $this->props['image_order'] ) {
                $images_array = dg_shuffle_assoc($images_array);
        ...
        $options = dg_ig_options(
            array('images_array' => $images_array),
            $this->props
        );

        $images = dg_ig_render_images($options);
	    ...
	    if('on' === $filter_nav && !empty($filter_nav_buttons)) {
		    ...
		    $filter_nav_markup = sprintf('<div class="dg_filter_buttons">%2$s%1$s</div>', $filter_nav_buttons, $first_btn);
	    }
        $load_more_icon = 'on' === $more_btn_use_icon ? sprintf('<span class="dg-ig-load-more-icon">%1$s</span>',
        ...
        $load_more_button = 'on' === $load_more ?
            sprintf('<div class="dg_ig_button_container">
	    ...
	    $older = !empty($this->props['older_text']) ? $this->props['older_text'] : 'Older Entries';
	    $next = !empty($this->props['newer_text']) ? $this->props['newer_text'] : 'Next Entries';
	    ...
	    if('on' === $show_pagination && count(explode(',',$image_ids)) > (int)$this->props['pagination_img_count']){
		    ob_start();
		    ?>
		    <div class="dg-ig-pagination pagination clearfix <?php echo 'on' === $this->props['use_icon_only_at_pagination'] ? 'only_icon':''; ?>">
        ...
        return sprintf('<div class="dg_ig_container%5$s" data-settings=\'%4$s\'>
                %2$s
                <div class="dg_ig_gallery grid" style="opacity:0;">
                    %1$s
                </div>
                %3$s
                %6$s
